...
En la última competencia realizada, la gran mayoría (por no decir todos), utilizaban C/C++ para el control de los robots, aplicandodistintos algoritmos de MATLAB (más adelante se detalla) para la optimización de la pista. La ventaja de esto es que MATLAB genera scripts en C/C++, por lo que se pueden utilizar algoritmos preexistentes sin mayores complicaciones, apoyado de la inclusión de Simulink, para una interacción más directa y simple entre MATLAB y el robot.
