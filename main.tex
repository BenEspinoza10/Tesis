...
\newcommand{\titulo}{Seguimiento, trazado y optimización de Robot Robotracer mediante visión computacional y aprendizaje reforzado}
\newcommand{\ciudad}{Santiago} % e.g. Valparaíso
% TODO: Consultar el formato de los nombres:
\newcommand{\nombrealumno}{Benjamín Nicolás Espinoza Huenunguir}
\newcommand{\nombreprofesor}{Ricardo Ñanculef}
\newcommand{\nombrecorreferente}{Andrés Bercovich}
...
\setmainfont{Calibri}[BoldFont={* Bold}]
\setmainfont{Calibri}[ItalicFont={* Italic}]
...
\usepackage{tocloft}
\renewcommand{\cftsecfont}{\fontsize{12}{14}\selectfont\fontspec{Calibri}}
\renewcommand{\cftsubsecfont}{\fontsize{12}{14}\selectfont\fontspec{Calibri}}
\renewcommand{\cftsubsubsecfont}{\fontsize{12}{14}\selectfont\fontspec{Calibri}}

\renewcommand\cftfigfont{\fontsize{12}{14}\selectfont\fontspec{Calibri}}
